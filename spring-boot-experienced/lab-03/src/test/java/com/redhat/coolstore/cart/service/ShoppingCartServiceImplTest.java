...
public class ShoppingCartServiceImplTest {
  ...
  public void setup() {
    ...
    ReflectionTestUtils.setField(shoppingCartService, null, priceCalculationService,
  ...
  public void testAddItemToCartWithOtherProducts() {
    ...
    Optional<ShoppingCartItem> sci = sc.getShoppingCartItemList().stream()
        .filter(i -> i.getProduct().getItemId().equals("p2")).findFirst();
